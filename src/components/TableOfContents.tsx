      ...
      <ul className="space-y-1 border-l border-orange-500/50 dark:[border-color:var(--dm-border)] pl-3">
        {headings.map(({ id, text, level }) => (
          ...
          >
            <a
              href={`#${id}`}
              className="block rounded-md px-1 -ml-1 text-muted-foreground hover:text-foreground hover:bg-orange-200/50 dark:hover:[background-color:var(--dm-bg)] transition-colors"
            >
              {text}
            </a>
          </li>
